                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ $current_lang == 'ar' ? 'ادارة الصور' : 'Mange Photos' }}</th>
                                        <th>{{ $current_lang == 'ar' ? 'ادارة الفديوهات' : 'Mange Videos' }}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td >{{ $index+1 }}</td>
                                        <td >   
                                            <a href="{{ url('public/uploads/fairs/'.$row->photo)  }}" target="blank">
                                                <img src="{{ url('public/uploads/fairs/'.$row->photo)  }}" width="50px" height="50px"> 
                                            </a>
                                        </td>
                                        <td > {{ $row->name_en }} </td>
                                        <td > {{ $row->name_ar }} </td>
                                        <td >   
                                            <a class="btn btn-primary" href="{{ route('dashboard.getfairPhotosById', $row->id) }}"> {{ $current_lang == 'ar' ? 'ادارة الصور' : 'Mange Photos' }} </a>
                                        </td>

                                        <td >   
                                            <a class="btn btn-info" href="{{ route('dashboard.getVideosById', $row->id) }}" >{{ $current_lang  == 'ar' ? 'ادارة الفديوهات' : 'Mange Videos' }}</a>
                                        </td>
                                        <td>
