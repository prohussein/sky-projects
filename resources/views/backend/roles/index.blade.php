                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                <thead>
                                    <tr>
                                        <th style="width:5%">#</th>
                                        <th style="width:15%">@lang('site.name') </th>
                                        <th style="width:45%">@lang('site.permissions')</th>
                                        <th style="width:15%">@lang('site.user_count') </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td > <h5> <span class=" badge badge-success"> {{ $row->users_count }} </span> </h5> </td>
                                        <td>
