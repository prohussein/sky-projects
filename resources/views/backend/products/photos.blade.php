...
@endcomponent 
   <div class="row">
      <div class="col-md-12">
         <div class="tile">
            <form action="{{ route('dashboard.addphotos') }}" method="POST" enctype="multipart/form-data">
                 @csrf
                    @method('post')
   ...
   <button style="margin-bottom: 10px" class="btn btn-primary delete_all" data-url="{{ url('photosDeleteAll') }}">Delete All Selected</button>
           ...
           <div class="row" >
               ...
               <div class="col-md-1" id="tr_{{$row->id}}">
                    ...
                    <input type="checkbox" class="sub_chk" data-id="{{$row->id}}">
                        ...
                        <img src="{{ asset('public/uploads/products/photos/'. $row->photo ) }}" width="90%">
